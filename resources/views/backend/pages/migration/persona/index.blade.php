                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            @endif
                            <form action="{{ route('migration.usuarios.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                            ...
                            <div class="card-block">
                                <div class="dt-responsive table-responsive">
                                    <table id="dataTable" class="table table-striped table-bordered nowrap">
                                        ...
                                        <tbody>
                                            @foreach ($mapPersonas as $persona)
                                                <tr>
                                                    <td>{{ $loop->index + 1 }}</td>
                                                    ...
                                                    <td>{{ $persona->per_en_funcion }}</td>
                                                    <td>{{ $persona->per_libreta_militar }}</td>
                                                    <td>{{ $persona->gen_nombre }}</td>
                                                    <td>{{ $persona->esp_nombre }}</td>
                                                    <td>{{ $persona->car_nombre }}</td>
                                                    <td>{{ $persona->cat_nombre }}</td>
                                                    <td>{{ $persona->sub_nombre }}</td>
                                                    <td>{{ $persona->area_nombre }}</td>
                                                    <td>{{ $persona->niv_nombre }}</td>
                                                    <td>{{ $persona->uni_edu_nombre }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                        <tfoot>
