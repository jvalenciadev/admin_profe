        ...
        <table width="100%" style="vertical-align: middle;">
            <tr style="">
                <td style="text-align:left; vertical-align: middle;">
                    <img src="data:image/jpeg;base64,{{ $logo5 }}" alt="" width="345">
                </td>
                <td style="text-align:right; vertical-align: middle;">
                    <div style="display: inline-block; text-align: center;">
                        <img src="data:image/png;base64,{{ $barcodeImage }}" alt="Código de Barras" width="195" height="35" style="vertical-align: middle;" />
        ...
        <table class="main-table" style="margin: 0;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="10%" style="text-align: center;">{{ $inscripcion->per_ci }}{{ $inscripcion->per_complemento ? '-' . $inscripcion->per_complemento : '' }}</td>
