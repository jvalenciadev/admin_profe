...
@section('styles')
    <style type="text/css">
        ...
        .text-success {
            font-weight: bold; /* Aumentar el grosor de la fuente para resaltar el promedio */
        }
    </style>
                                                    ...
                                                    <div>
                                                        ...
                                                        @if ($usr->can('calificacion.reporte'))
                                                            @foreach ($modulos->unique('pm_id') as $modulo)
                                                                <a target="_blank"
                                                                    href="{{ route('admin.calificacion.reportecalificacioninvpdf', [
                                                                        'sede_id' => $sede_id,
                                                                ...
                                                                @foreach ($modulos as $modulo)
                                                                    <th style="text-align: center; font-size: 12px;">
                                                                        ...
                                                                        <span style="font-size: 9px; display: block;">
                                                                            @if ($modulo->ptc_nota == 80)
                                                                                PRODUCTO FINAL
                                                                            @elseif ($modulo->ptc_nota == 20)
                                                                                ACTIVIDAD
                                                                            @endif
                                                                        </span>
                                                                        <span style="font-size: 12px;">({{ $modulo->ptc_nota }} ptos.)</span>
                                                                    </th>
                                                                @endforeach
                                                            </tr>
                                                        </thead>
                                                        ...
                                                        <tbody>
                                                            @foreach ($inscripcionesGrouped as $inscripcion)
                                                                <tr>
                                                                    ...
                                                                    @endphp
                                                                    @foreach ($modulos as $modulo)
                                                                        @if ($usr->can('calificacion.edit') || $inscripciones->first()->pro_id==4)
                                                                            @php
