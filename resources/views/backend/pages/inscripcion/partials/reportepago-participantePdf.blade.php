    ...
    <main style="text-align: left; padding: 20px 55px; ">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td width="20%" style="background-color: #ddd; padding: 5px; ">NRO. DE RDA</td>
            ...
            <tr>
                ...
                <td width="20%" style="background-color: #ddd; padding: 5px; ">NRO. DE CELULAR</td>
        ...
        <table width="100%" style="margin-top: 20px">
            <tr>
                <td width="100%" style="background-color: #ddd; padding: 5px; ">
                    <b>DATOS DEL DEPÓSITO BANCARIO</b>
                </td>
            </tr>
        </table>
        ...
        <table width="100%">
            <thead>
                <tr>
                    <th width="20%" style="background-color: #ddd; padding: 5px; ">NÚMERO DE DEPÓSITO</th>
