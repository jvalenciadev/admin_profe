                ...
                <div class="col-12 ">
                    ...
                    <div class="card shadow-lg">
                        <div class="alert alert-warning text-center shadow-sm mb-3" role="alert">
                            <strong>¡Atención!</strong> Este formulario es <u>obligatorio</u>. Por favor, asegúrese de completar todos los campos correctamente antes de guardar.
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.datosnacres.update', ['per_id' => $inscripcion->per_id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control shadow-sm" id="per_nac_provincia"
                                                        name="per_nac_provincia" placeholder="Ingrese la provincia"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control shadow-sm" id="per_nac_municipio"
                                                        name="per_nac_municipio" placeholder="Ingrese el municipio"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control shadow-sm" id="per_nac_localidad"
                                                        name="per_nac_localidad" placeholder="Ingrese la localidad"
                                    ...
                                    <div class="col-md-6 mb-1" style="border-left: 2px solid #007bff;">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control shadow-sm"
                                                        ...
                                                        placeholder="Ingrese la provincia" value="{{ $mapPersonaNr->per_res_provincia ?? '' }}" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control shadow-sm"
                                                        ...
                                                        placeholder="Ingrese el municipio" value="{{ $mapPersonaNr->per_res_municipio ?? '' }}" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control shadow-sm"
                                                        ...
                                                        placeholder="Ingrese la localidad" value="{{ $mapPersonaNr->per_res_localidad ?? '' }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control shadow-sm" id="per_res_direccion"
                                                name="per_res_direccion" placeholder="Ingrese la dirección" value="{{ $mapPersonaNr->per_res_direccion ?? '' }}" required>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="pro_bau_tipo_pago" class="form-control">
                                                    ...
                                                    <option value="Descuento por Planilla"
                                                        {{ $baucher->pro_bau_tipo_pago == 'Descuento por Planilla' ? 'selected' : '' }}>
                                                        Descuento por Planilla</option>
                                                </select>
                                            </div>
                                            @if ($usr->can('inscripcion.bauchereditar'))
                                            ...
                                            <form
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="pro_bau_tipo_pago" class="form-control">
                                                        ...
                                                        <option value="Descuento por Planilla">Descuento por Planilla
                                                        </option>
                                                    </select>
                                                </div>
