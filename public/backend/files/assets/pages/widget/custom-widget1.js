...
$(document).ready(function () {
  ...
  var myChart = new Chart(ctx, {
    ...
    data: valincomearrow(
      "#007cab",
      [30, 15, 25, 35, 30, 20, 15, 20, 25, 40, 25, 30, 22, 31],
      "#007cab"
    ),
  ...
  var myChart = new Chart(ctx, {
    ...
    data: valincomearrow(
      "#fe9365",
      [40, 25, 30, 22, 30, 15, 25, 35, 30, 20, 15, 20, 25, 31],
      "#fe9365"
    ),
    options: valincomearowbuildoption(),
  });
  ...
  var myChart = new Chart(ctx, {
    ...
    data: valincomearrow(
      "#0ac282",
      [25, 30, 20, 15, 20, 25, 31, 22, 30, 15, 25, 35, 30, 40],
      "#0ac282"
    ),
    options: valincomearowbuildoption(),
  });
      ...
      datasets: [
        {
          ...
          fill: true,
          lineTension: 0,
          backgroundColor: Chart.helpers.color(f).alpha(0.7).rgbString(),
          data: b,
        },
      ],
    };
  ...
  window.myDoughnut = new Chart(ctx, {
    ...
    data: {
      datasets: [
        {
          data: [10, 34, 5],
          backgroundColor: ["#fe9365", "#007cab", "#fe5d70"],
          label: "Dataset 1",
        },
      ],
