...
use App\Imports\MapEspecialidadImport;
...
class EspecialidadController extends Controller
{
    ...
    public function index()
    {
        ...
        //$MapEspecialidad = MapEspecialidad::paginate(100);
        return view('backend.pages.migration.especialidad.index', compact('especialidades'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            Excel::import(new MapEspecialidadImport, $file);

            return redirect()->route('migration.especialidad.index')->with('success', 'La importación se ha realizado con éxito.');
