...
use App\Imports\UnidadEducativaImport;
...
class UnidadEducativaController extends Controller
{
    ...
    public function index()
    {
        ...
        $unidadeducativas  = UnidadEducativa::all();
        //$mapPersona = MapPersona::paginate(100);
        return view('backend.pages.migration.unidad_educativa.index', compact('unidadeducativas'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            Excel::import(new UnidadEducativaImport, $file);

            return redirect()->route('migration.unidadeducativa.index')->with('success', 'La importación se ha realizado con éxito.');
