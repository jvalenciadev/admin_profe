...
INSERT INTO `admins` (`id`, `nombre`, `correo`, `username`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
...
ALTER TABLE `admins`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `admins_email_unique` (`correo`),
